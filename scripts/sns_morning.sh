...
exec >> "$LOG/launchagent_morning.log" 2>&1
echo "[$(date '+%Y-%m-%d %H:%M:%S')] === 朝の投稿開始 ==="
...
TIKTOK_VIDEO_LOG="$LOG/cron_tiktok_video.log"
...
echo "[$(date '+%Y-%m-%d %H:%M:%S')] === 朝の投稿すべて完了 ==="
